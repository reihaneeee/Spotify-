...
const SupportAndApproval = ({ tickets, pendingArtists, onReply, onCloseTicket, onApprove, onReject }) => {
  ...
  return (
    <div>
      ...
      <div>
        {activeTab === 'tickets' && (
          <TicketsSection tickets={tickets} onReply={onReply} onCloseTicket={onCloseTicket} />
        )}
        {activeTab === 'approval' && (
