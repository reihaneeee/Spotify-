...
const DEFAULT_AVATAR =
  'https://ui-avatars.com/api/?name=Artist&background=1db954&color=fff&size=200';

export default function ArtistHeader({ artist, following, onFollowToggle }) {
  return (
    <header className="artist-header">
      ...
      <div className="artist-info">
        ...
        <span className="artist-kicker">Artist</span>
