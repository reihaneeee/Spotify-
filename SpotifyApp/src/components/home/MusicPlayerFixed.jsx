...
export default function MusicPlayerFixed({ currentUser }) {
  // حفظ متد افزایش آمار بدون دستکاری بقیه مقادیر کانتکست (کد شما)
  ...
  // سناریو اتمام آهنگ: هر وقت اسلایدر پر شد، آمار را ثبت و در صورت لزوم تکرار می‌کند (کد شما)
  useEffect(() => {
  ...
  // استخراج داینامیک آمار جدید از لوکال استوریج با حفظ ظاهر فرمت میلیون (M) (کد شما)
  const getLiveStats = () => {
